  ...
  return (
    <>
      <div className="home-main">
        <div className="home">
          <h1>Hungertime Restaurant Management Software</h1>
          <p>
            An advanced feature-rich best restaurant management software in
            India With features like menu, staff, inventory, branch management,
            and more. Hungertime restaurant management software will help you
            write your restaurant's success! Hungertime software flexibility
            ensures that businesses can adapt to changing circumstances,
            seasonal variations, or unexpected supply chain challenges with
            remarkable agility.
          </p>
      ...
      <div className="feature-group-home">
        <div className="feature-box">
          <h5>Menu Management</h5>
          <ol>
            <li>Take control of your menu items</li>
            <li>Define your delivery areas</li>
            <li>Select the item categories</li>
          </ol>
        </div>
        <div className="feature-box">
          <h5>order Management</h5>
          <ol>
            <li>Order Tracking and visibility</li>
